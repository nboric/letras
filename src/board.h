...
public:
    ...
    virtual bool placeTemp(std::vector<std::unique_ptr<Tile> >& tiles, std::vector<Placement>& placements,
...
public:
    ...
    bool placeTemp(std::vector<std::unique_ptr<Tile> >& tiles, std::vector<Placement>& placements,
